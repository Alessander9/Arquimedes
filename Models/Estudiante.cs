...
public class Estudiante
{
    ...
    [Required(ErrorMessage = "El campo Código Estudiante es obligatorio")]
    [RegularExpression(@"@arquimedes-edu\.com$", ErrorMessage = "El código debe terminar con '@arquimedes-edu.com'")]
    ...
    public Estudiante(string codEstudiante, string nombreEstudiante, string apellidoEstudiante, int edadEstudiante, int anioEstudiante, string seccionEstudiante, string telefono, string direccion, string gradoAcademico, string estadoEstudiante)
    {
